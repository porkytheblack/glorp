/**
 * Station MCP provisioning: createWorkspace minting + the workspace-scoped
...
import { mcpRoutes } from "../src/station/routes/mcp.ts";
import type { ToolDef, ToolLister } from "../src/mcpgen/index.ts";

const tmpDirs: string[] = [];
function tmp(prefix = "station-mcp-"): string {
