...
import { isVisibleTranscriptMessage, visibleMessageText } from "./messages.ts";

const TITLE_MAX_MESSAGES = 10;
const TITLE_MAX_CHARS_PER_MESSAGE = 700;

export const TITLE_MODEL_TIMEOUT_MS = 15_000;
      ...
      messages: [
        {
          ...
          text:
            ...
            "Rules: return only the title, no quotes, no markdown, no trailing punctuation, " +
