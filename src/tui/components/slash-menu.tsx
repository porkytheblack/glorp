...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { name: "/mcp", description: "manage MCP servers (connect / disconnect)" },
  { name: "/model", description: "open the model switcher" },
  { name: "/agents", description: "manage conversational agents" },
  { name: "/sessions", description: "switch or create a session" },
  { name: "/permissions", description: "review saved tool permissions" },
