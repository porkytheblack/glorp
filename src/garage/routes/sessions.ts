 ...
 */
export function sessionWsUrl(config: GarageConfig, id: string): string {
...
export function sessionRoutes(manager: SessionManager, config: GarageConfig): SessionRoutes {
