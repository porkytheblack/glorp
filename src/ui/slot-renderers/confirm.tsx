 ...
 * n/esc = false.
 */
export function ConfirmSlot({ slot, onResolve }: SlotRendererProps) {
  ...
  useKeyboard((key) => {
    ...
    else if (key.name === "n" || key.name === "escape") onResolve(false);
  });
      ...
      >
        ...
        <box marginTop={1}>
          <text fg={theme.textMuted}>
            ...
            <span fg={theme.error}>n/esc</span> {input.noLabel ?? "no"}
          </text>
        </box>
      </box>
    </box>
